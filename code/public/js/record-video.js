'use strict';
   ...
   var videoRecord = document.querySelector("#record"),
       ...
       btnStop.onclick = function()
       {
           ...
           btnResume.disabled = true;
               ...
               a.target = '_blank';
               a.innerHTML ="Recorded Video No."+(index++);
       ...
       function onMediaSuccess(stream)
       {
          ...
          var channel2 = [1,0];
           ...
           videoRecord.controls = false;
           videoRecord.muted = false;
          ...
          var options = { audioBitsPerSecond : 128000, videoBitsPerSecond : 2500000, mimeType : 'video/webm;codecs=vp9'};
           try{   
